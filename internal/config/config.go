...
func ConnectToDB() (*gorm.DB, error) {
	...
	dsn := fmt.Sprintf("%s:%s@tcp(%s:%s)/%s?charset=utf8mb4&parseTime=True&loc=Local",
		os.Getenv("TASK_ROOT"),        // Usuario de la base de datos
		os.Getenv("TASK_PASSWORD"),    // Contraseña de la base de datos
		os.Getenv("TASK_HOST"),        // Dirección del host de la base de datos
		os.Getenv("TASK_PORT"),        // Puerto de la base de datos
		os.Getenv("TASK_NAME"),        // Nombre de la base de datos
	)
